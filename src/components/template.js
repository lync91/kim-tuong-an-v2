  ...
  return (
    <div className="row">
      <div className="column center" >
        ...
        <p style={{margin: 2}}><b>{`${data.monhang}`}</b></p>
      ...
      <div className="column" style={{paddingLeft: 100, width: '75%'}} >
        ...
        <p style={{marginTop: 10, paddingLeft: 30, fontSize: 20}}><b>{data.tenkhach}</b></p>
        <p style={{marginTop: 3, paddingLeft: 30, fontSize: 20}}><b>{`${data.monhang}`}</b> </p>
        {/* <p style={{marginTop: 3, paddingLeft: 30, fontSize: 20}}> <b>{data.trongluongthuc} chỉ</b></p> */}
        <p style={{paddingLeft: 20, fontSize: 20, marginTop: 38, fontSize: 20}}>
